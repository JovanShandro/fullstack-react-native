 ...
 */
function shuffleBoard(puzzle: Puzzle): Puzzle {
 ...
 */
export function movableSquares(puzzle: Puzzle): number[] {
 ...
 */
export function availableMove(puzzle: Puzzle, square: number): string {
 ...
 */
export function getIndex(puzzle: Puzzle, square: number) {
  const { board } = puzzle;
